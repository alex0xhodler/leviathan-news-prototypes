...
(function () {
  ...
  var VARIANTS = [
    ...
    { n: 6, file: 'variant-6-agentic.html', name: 'Dual-Species Portal', tag: 'Agentic' }
  ];
  ...
  css.textContent = [
    ...
    'border:1px solid rgba(0,210,255,.18);border-radius:999px;',
    ...
    '.lvx-dock a:hover,.lvx-dock button:hover{color:#e6edf7;background:rgba(0,210,255,.08);}',
    '.lvx-dock a.lvx-active{color:#00d2ff;background:rgba(0,210,255,.12);}',
    '.lvx-dock .lvx-hub{color:#e5a93c;}',
    '.lvx-dock .lvx-dot{width:7px;height:7px;border-radius:50%;flex:none;}',
    '.lvx-dot.live{background:#4ade80;box-shadow:0 0 8px #4ade80;animation:lvxPulse 2s infinite;}',
    '.lvx-dot.fixture{background:#e5a93c;}',
    '.lvx-dot.connecting,.lvx-dot.reconnecting{background:#facc15;animation:lvxPulse 1s infinite;}',
    ...
    'background:rgba(10,15,26,.95);border:1px solid rgba(0,210,255,.25);border-radius:8px;',
